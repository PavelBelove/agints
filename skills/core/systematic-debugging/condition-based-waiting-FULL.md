# Condition-Based Waiting — Full Reference
...
// After (reliable): Waiting for condition
...
**Stale data:** Caching state before loop. Fix: call getter inside loop for fresh data.
...
Requirements when using arbitrary timeout legitimately:
