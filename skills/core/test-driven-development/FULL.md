# Test-Driven Development (TDD) — Full Reference
...
| "Existing code has no tests" | You're improving it. Add tests for existing code too. |
...
**REFACTOR**
Extract validation if handling multiple fields.
...
- Incomplete mocks that pass but hide real integration issues
